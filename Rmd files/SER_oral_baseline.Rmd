...
FINAL MODEL: Negative binomial model offset included, removing the anystim and anyopiate variables.
```{r}
...
#confidence intervals for  coefficients
(CI_model.nb.offset.reduced <- cbind(Estimate = coef(model.nb.offset.reduced), confint(model.nb.offset.reduced)))
exp(CI_model.nb.offset.reduced)
```
