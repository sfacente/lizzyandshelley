...
1) Exposure as 3 level variable or keep it in its 5 level ordinal original form? Don't want to assume a monotonic relationship, can look at both as sensitivty analysis. 
...
Might be that # sharing exceeds # of injection events
offset must be log

6) Negative binomial interpretation. After exponentiating the betas:

more like risk ratio because denominator is underlying numbe of events

Is it "those who always injected in public have X times the rate of syringe sharing vs those who did not inject in public"? (since the underlying recall period is the same for everyone)
