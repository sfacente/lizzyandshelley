...
###WE NEED TO CODE THESE SYRINGE ACCESS VARIABLES BETTER. RIGHT NOW SOURCE OF SYRINGES HAS TOO MANY CATEGORIES AND NUMBER OF NEEDLES HAS WAY TOO MANY INTEGERS. 
table(df_allwaves$NDLSRCF, useNA = "ifany")
...
myVars <- c("LOCALID", "GENDER","agecat","RACE_cat", "ED","HOMELESS", "STIM.freq", "OPIOID.freq", "OAT6month", "WOD6M", "ODP6M", "NDLSRCF", "NMNDLES") 

# Specify which of the variables are categorical
catVars <- c("LOCALID", "GENDER", "agecat", "RACE_cat", "ED","HOMELESS", "STIM.freq", "OPIOID.freq","OAT6month", "WOD6M", "ODP6M", "NDLSRCF") 
