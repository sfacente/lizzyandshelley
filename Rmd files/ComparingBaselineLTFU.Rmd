...
df_allwaves$NMNDLES.test1 <- as.character.factor(df_allwaves$NMNDLES)
df_allwaves$NMNDLES.test1 <- as.numeric(df_allwaves$NMNDLES.test1)
...
myVars <- c("LOCALID", "GENDER","agecat","RACE_cat", "ED","HOMELESS", "STIM.freq", "OPIOID.freq", "OAT6month", "WOD6M", "ODP6M", "needleexchange") 
