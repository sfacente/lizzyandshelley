...
Create variables to compare those who would eventually show up to 12-month visit (FU2) to those who would not.
```{r}
#city
...
Create a table to compare those who would eventually show up to 12-month visit (FU2) to those who would not. 
```{r}
