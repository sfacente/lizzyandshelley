...
NAL6MOS.new: All bivariate models converge using log-binomial model, but multivariate log-binomial model will not converge, so will use modified poisson instead.
```{r}
