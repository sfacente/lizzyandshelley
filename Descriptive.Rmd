...
dfslong$PUBINJord <- as.numeric(ifelse(dfslong$PUBINJ=="Never (0% of the time)", 0, ifelse(dfslong$PUBINJ=="Occasionally (less than 25% of the time)", 1, ifelse(dfslong$PUBINJ=="Sometimes (25% to 74% of the time)", 2, ifelse(dfslong$PUBINJ=="Usually (75% to 99% of the time)", 3, ifelse(ifelse(dfslong$PUBINJ==" Always (100% of the time)", 4, NA)))))))
...
tabledfslong$YRSHOME <- dfslong$MOSHOME/12
```


dfslong$IJWOTHord <- as.numeric(ifelse(dfslong$IJWOTH=="Never (0% of the time)", 0, ifelse(dfslong$IJWOTH=="Occasionally (less than 25% of the time)", 1, ifelse(dfslong$IJWOTH=="Sometimes (25% to 74% of the time)", 2, ifelse(dfslong$IJWOTH=="Usually (75% to 99% of the time)", 3, ifelse(ifelse(dfslong$IJWOTH==" Always (100% of the time)", 4, NA)))))))
...
#Why is there no main effect of public injecting? why doesn't the summary comment gives me more than just the coefficients?
library(gee)
