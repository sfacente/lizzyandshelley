...
names(df)
dim(df)
length(unique(dfc$SUBJECT))

table(dfc$GENDER, useNA = "ifany")
table(dfc$FU1, useNA = "ifany")
table(dfc$FU2, useNA = "ifany")


#look at homeless variables
table(dfc$HOMELESS, useNA = "ifany")
table(dfc$HOMELESS1, useNA = "ifany")
table(dfc$HOMELESS2, useNA = "ifany")

#look at homeless variables ricky created
table(dfc$NVHOUSED, useNA = "ifany")
table(dfc$ALWYSHL, useNA = "ifany")
table(dfc$HOUSED, useNA = "ifany")
