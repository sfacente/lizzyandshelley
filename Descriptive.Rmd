...
# #speedball
# table(df$SB30, useNA = "ifany")
# table(df$SB301, useNA = "ifany")
# table(df$SB302, useNA = "ifany")

# #speedball injection
# table(df$SBINJ, useNA = "ifany")

df$SBINJ1 <- ifelse(df$SBINJ1=="No", "No", ifelse(df$SBINJ1=="Yes", "Yes", NA))
# table(df$SBINJ1, useNA = "ifany")
# table(df$SBINJ2, useNA = "ifany")
# 
# #goofball
# table(df$GB30, useNA = "ifany")
# table(df$GB301, useNA = "ifany")
# table(df$GB302, useNA = "ifany")
# 
# #goofball injection
# table(df$GBINJ, useNA = "ifany")

df$GBINJ1 <- ifelse(df$GBINJ1=="No", "No", ifelse(df$GBINJ1=="Yes", "Yes", NA))
# table(df$GBINJ1, useNA = "ifany")
# table(df$GBINJ2, useNA = "ifany")
# 
# #crack
# table(df$CRCK30, useNA = "ifany")
# table(df$CRCK301, useNA = "ifany")
# table(df$CRCK302, useNA = "ifany")
# 
# #crack injection
...
# 
# #powder cocaine
# table(df$PCOKE30, useNA = "ifany")
# table(df$PCOKE301, useNA = "ifany")
# table(df$PCOKE302, useNA = "ifany")
# 
...
# 
# #meth
# table(df$METH30, useNA = "ifany")
# table(df$METH301, useNA = "ifany")
# table(df$METH302, useNA = "ifany")
# 
# #meth injection
...
# table(df$HER301, useNA = "ifany")
# table(df$HER302, useNA = "ifany")
# 
# #heroin injection
...
# 
# #marijuana
# table(df$MJ30, useNA = "ifany")
# table(df$MJ301, useNA = "ifany")
# table(df$MJ302, useNA = "ifany")
# 
# #alcohol
# table(df$ALCTX, useNA = "ifany")
# table(df$ALCTX1, useNA = "ifany")
# table(df$ALCTX2, useNA = "ifany")
...
# #make sure the binge variables worked
# table(df$binge)
# table(df$binge1)
# table(df$binge2)
...
gFU1b <- glm(FU1 ~ RECSHR + PUBINJ + HOMELESS + IJWOTH + GENDER + AGE + ANYSTIM, family = "binomial", data = dfs2, na.action = na.omit)
gFU1c <- glm(FU1 ~ RECSHR + PUBINJ + HOMELESS + IJWOTH + GENDER + AGE + ANYSTIM, family = "binomial", data = dfs3, na.action = na.omit)
gFU1d <- glm(FU1 ~ RECSHR + PUBINJ + HOMELESS + IJWOTH + GENDER + AGE + ANYSTIM, family = "binomial", data = dfs4, na.action = na.omit)
gFU1e <- glm(FU1 ~ RECSHR + PUBINJ + HOMELESS + IJWOTH + GENDER + AGE + ANYSTIM, family = "binomial", data = dfs5, na.action = na.omit)
...
gFU2a <- glm(FU2 ~ FU1 + RECSHR + PUBINJ + HOMELESS + MOSHOME + IJWOTH + GENDER + AGE, family = "binomial", data = dfs1, na.action = na.omit) 
gFU2b <- glm(FU2 ~ FU1 + RECSHR + PUBINJ + HOMELESS + MOSHOME + IJWOTH + GENDER + AGE, family = "binomial", data = dfs2, na.action = na.omit) 
gFU2c <- glm(FU2 ~ FU1 + RECSHR + PUBINJ + HOMELESS + MOSHOME + IJWOTH + GENDER + AGE, family = "binomial", data = dfs3, na.action = na.omit) 
gFU2d <- glm(FU2 ~ FU1 + RECSHR + PUBINJ + HOMELESS + MOSHOME + IJWOTH + GENDER + AGE, family = "binomial", data = dfs4, na.action = na.omit) 
gFU2e <- glm(FU2 ~ FU1 + RECSHR + PUBINJ + HOMELESS + MOSHOME + IJWOTH + GENDER + AGE, family = "binomial", data = dfs5, na.action = na.omit) 
...
- look into those who weren't homeless but injected outside
