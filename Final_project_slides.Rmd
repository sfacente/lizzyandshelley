...
plot1 <- ggplot(data = subset(dfslong2, VISIT=="baseline"), aes(x = PUBINJ_3cat, y = TIMESHARE, color = PUBINJ_3cat)) +
  geom_boxplot(aes(fill=factor(PUBINJ_3cat))) + scale_fill_manual(values=cbPalette) + scale_x_discrete(labels=c("Never", "Sometimes/Often", "Usually/Always")) + labs(y= "Times shared", x = "Baseline") + theme(legend.position = "none") + theme(axis.text.x = element_text(size=7)) + scale_color_brewer(palette = "Dark2")
plot2 <- ggplot(data = subset(dfslong2, VISIT=="FU1"), aes(x = PUBINJ_3cat, y = TIMESHARE, color = PUBINJ_3cat)) +
  geom_boxplot(aes(fill=factor(PUBINJ_3cat))) + scale_fill_manual(values=cbPalette) + scale_x_discrete(labels=c("Never", "Sometimes/Often", "Usually/Always")) + labs(y= "Times shared", x = "6-month visit") + theme(legend.position = "none") + theme(axis.text.x = element_text(size=7)) + scale_color_brewer(palette = "Dark2")
plot3 <- ggplot(data = subset(dfslong2, VISIT=="FU2"), aes(x = PUBINJ_3cat, y = TIMESHARE, color = PUBINJ_3cat)) +
  geom_boxplot(aes(fill=factor(PUBINJ_3cat))) + scale_fill_manual(values=cbPalette) + scale_x_discrete(labels=c("Never", "Sometimes/Often", "Usually/Always")) + labs(y= "Times shared", x = "12-month visit") + theme(legend.position = "none") + theme(axis.text.x = element_text(size=7)) + scale_color_brewer(palette = "Dark2")
