...
|Sometimes/Often publicly inject | | `r round(out.all[1,2], 2)` | `r round(out.all[1,4], 2)`| | `r round(out.all[1,5], 2)` | `r format(out.all[1,6], digits=2)` | | `r round(out.all[1,7], 2)` | `r format(out.all[1,8], digits=2)` | 
