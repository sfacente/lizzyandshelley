...
#poisson
modelpoisson_categorical1 <- glmer(TIMESHARE ~ PUBINJ_3cat*HOMELESS + PUBINJ_baseline + GENDER + AGE + ANYSTIM + ANYOPIATE + binge + (1|SUBJECT) + offset(log(SUMINJ)), family = "poisson", data = dfslong, na.action = na.omit)
modelpoisson_categorical2 <- glmer(TIMESHARE ~ (PUBINJ_3cat|SUBJECT)*(HOMELESS|SUBJECT) + PUBINJ_baseline + GENDER + AGE + (ANYSTIM|SUBJECT) + (ANYOPIATE|SUBJECT) + (binge|SUBJECT) + (1|SUBJECT) + offset(log(SUMINJ)), family = "poisson", data = dfslong, na.action = na.omit)
modelpoisson_categorical3 <- glmer(TIMESHARE ~ (PUBINJ_3cat|SUBJECT)*(HOMELESS|SUBJECT) + PUBINJ_baseline + GENDER + AGE + ANYSTIM + ANYOPIATE + binge + (1|SUBJECT) + offset(log(SUMINJ)), family = "poisson", data = dfslong, na.action = na.omit)
modelpoisson_categorical4 <- glmer(TIMESHARE ~ PUBINJ_3cat*(HOMELESS|SUBJECT) + PUBINJ_baseline + GENDER + AGE + ANYSTIM + ANYOPIATE + binge + (1|SUBJECT) + offset(log(SUMINJ)), family = "poisson", data = dfslong, na.action = na.omit)
modelpoisson_categorical5 <- glmer(TIMESHARE ~ (PUBINJ_3cat|SUBJECT)*HOMELESS + PUBINJ_baseline + GENDER + AGE + ANYSTIM + ANYOPIATE + binge + (1|SUBJECT) + offset(log(SUMINJ)), family = "poisson", data = dfslong, na.action = na.omit)
