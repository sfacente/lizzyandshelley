...
#poisson
#WANT TO ADD offset(log(SUMINJ))
modelpoisson_categorical1 <- glmer(TIMESHARE ~ PUBINJ_3cat*HOMELESS + PUBINJ_baseline + GENDER + AGE + ANYSTIM + ANYOPIATE + binge + (1|SUBJECT), family = "poisson", data = dfslong, na.action = na.omit)
modelpoisson_categorical2 <- glmer(TIMESHARE ~ (PUBINJ_3cat|SUBJECT)*(HOMELESS|SUBJECT) + PUBINJ_baseline + GENDER + AGE + (ANYSTIM|SUBJECT) + (ANYOPIATE|SUBJECT) + (binge|SUBJECT) + (1|SUBJECT), family = "poisson", data = dfslong, na.action = na.omit, control=glmerControl(check.nobs.vs.nRE="warning"))
modelpoisson_categorical3 <- glmer(TIMESHARE ~ (PUBINJ_3cat|SUBJECT)*(HOMELESS|SUBJECT) + PUBINJ_baseline + GENDER + AGE + ANYSTIM + ANYOPIATE + binge + (1|SUBJECT), family = "poisson", data = dfslong, na.action = na.omit, control=glmerControl(check.nobs.vs.nRE="warning"))
modelpoisson_categorical4 <- glmer(TIMESHARE ~ PUBINJ_3cat*(HOMELESS|SUBJECT) + PUBINJ_baseline + GENDER + AGE + ANYSTIM + ANYOPIATE + binge + (1|SUBJECT), family = "poisson", data = dfslong, na.action = na.omit, control=glmerControl(check.nobs.vs.nRE="warning"))
modelpoisson_categorical5 <- glmer(TIMESHARE ~ (PUBINJ_3cat|SUBJECT)*HOMELESS + PUBINJ_baseline + GENDER + AGE + ANYSTIM + ANYOPIATE + binge + (1|SUBJECT), family = "poisson", data = dfslong, na.action = na.omit, control=glmerControl(check.nobs.vs.nRE="warning"))
AICs <- AIC(modelpoisson_categorical1, modelpoisson_categorical2, modelpoisson_categorical3, modelpoisson_categorical4, modelpoisson_categorical5)
