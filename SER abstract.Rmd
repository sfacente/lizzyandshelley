...
NB1CIs <- confint(modelnb_categorical1, level = 0.95, method = "boot", seed = 242, nsim = 500, boot.type = "basic", .progress = "txt")
...
NB2CIs <- confint(modelnb_categorical2, level = 0.95, method = "boot", seed = 242, nsim = 500, boot.type = "basic", .progress = "txt")
...
NB2CIs_offset <- confint(modelnb_categorical2_offset, level = 0.95, method = "boot", seed = 242, nsim = 500, boot.type = "basic", .progress = "txt")
NB.out_offset <- data.frame(Est.MM.NB=NB.est_offset[,1], CI_LB.MM.NB=NB2CIs_offset[2:14,1], CI_UB.MM.NB=NB2CIs_offset[2:14,2]); NB.out_offset
...
save(modelgee_categorical, modelnb_categorical1, modelnb_categorical2, modelnb_categorical2_offset, NB1CIs, NB2CIs, NB2CIs_offset, out.all, file="regressoutput.Rdata")
```
